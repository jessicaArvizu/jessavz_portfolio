    ...
    <div className="bg-amethyst bg-gradient-to-r from-amethyst to-lavender">
      <VerticalTimeline lineColor='#5f689f'>
        <VerticalTimelineElement
          ...
          contentArrowStyle={{ borderRight: '7px solid rgba(255, 255, 255, 0.10)', marginLeft:'1px' }}
        ...
        <VerticalTimelineElement
          ...
          contentArrowStyle={{ borderRight: '8px solid rgba(255, 255, 255, 0.10)', marginRight:'1px' }}
        ...
        <VerticalTimelineElement
         ...
         border: '1px solid rgba(255, 255, 255, 0.01',
         color: '#f5f0ea' }}
         contentArrowStyle={{ borderRight: '8px solid rgba(255, 255, 255, 0.10)', marginLeft:'1px' }}
